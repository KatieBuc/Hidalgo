...
def test_initialise_params():
    ...
    N_check = 10
    V_check = [3.67521, 2.67584, ]
    NN_check = [6, 4, ]
    d_check = [1., 1.]
    p_check = [0.5, 0.5]
    a1_check = [7.,5.,]
    b1_check = [4.67521, 3.67584, ]
    c1_check = [7, 5, ]
    Z_check = [1, 0, 0, 1, 0, 1, 1, 0, 0, 0, ]
    N_in_check = 12
    f1_check = [13., 19., ]
    pp_check = 0.5
...
def test_gibbs_sampling():
    ...
    #random list arg
    sampling = model.gibbs_sampling(N, MU,Iin,Iout,Iout_count,Iout_track,V, NN, d, p, a1, b1, c1, Z, f1, N_in, pp, r)
    ...
    sampling_check = [1.54721,1.1892,0.694958,0.305042,0,1,0,1,1,0,0,0,0,1,-18.4875,-8.44254,]
